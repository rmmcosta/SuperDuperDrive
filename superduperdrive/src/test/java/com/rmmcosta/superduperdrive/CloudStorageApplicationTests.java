...
class CloudStorageApplicationTests {
	...
	private void doMockSignUp(String firstName, String lastName, String userName, String password){
		...
		// Attempt to sign up.
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("signup")));
		WebElement buttonSignUp = driver.findElement(By.id("signup"));
		buttonSignUp.click();
	...
	private void doLogIn(String userName, String password)
	{
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("floatingInput")));
		WebElement loginUserName = driver.findElement(By.id("floatingInput"));
		loginUserName.click();
		loginUserName.sendKeys(userName);

		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("floatingPassword")));
		WebElement loginPassword = driver.findElement(By.id("floatingPassword"));
		loginPassword.click();
		...
		webDriverWait.until(ExpectedConditions.titleContains("SDD"));//SDD stands for Super Duper Drive
	...
	public void testLargeUpload() {
		...
		webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("file-new")));
		WebElement fileSelectButton = driver.findElement(By.id("file-new"));
